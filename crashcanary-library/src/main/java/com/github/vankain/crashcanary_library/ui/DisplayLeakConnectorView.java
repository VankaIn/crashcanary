...
public final class DisplayLeakConnectorView extends View {
    ...
    static {
        iconPaint.setColor(CrashCanaryUi.LIGHT_GREY);
        rootPaint.setColor(CrashCanaryUi.ROOT_COLOR);
        leakPaint.setColor(CrashCanaryUi.LEAK_COLOR);
        clearPaint.setColor(Color.TRANSPARENT);
        clearPaint.setXfermode(CrashCanaryUi.CLEAR_XFER_MODE);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (cache == null) {
            ...
            float strokeSize = CrashCanaryUi.dpToPixel(4f, getResources());
