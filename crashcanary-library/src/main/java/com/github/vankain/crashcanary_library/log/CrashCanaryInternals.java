 ...
 */
public final class CrashCanaryInternals {
        ...
        if (android.os.Environment.MEDIA_MOUNTED.equals(state)) {
            if (android.os.Environment.getExternalStorageDirectory().canWrite()) {
                return android.os.Environment.getExternalStorageDirectory().getPath()
                        + CrashCanaryContext.get().getLogPath();
            }
        }
        return android.os.Environment.getDataDirectory().getAbsolutePath() + CrashCanaryContext.get().getLogPath();
    }
    ...
    public static File[] getLogFiles() {
        File f = CrashCanaryInternals.detectedLeakDirectory();
